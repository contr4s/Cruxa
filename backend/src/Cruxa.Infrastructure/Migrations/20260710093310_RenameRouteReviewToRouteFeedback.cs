...
{
    /// <inheritdoc />
    public partial class RenameRouteReviewToRouteFeedback : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradeIndex = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_route_feedback", x => x.Id);
                    table.ForeignKey(
                        name: "FK_route_feedback_routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_route_feedback_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_route_feedback_RouteId",
                table: "route_feedback",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_route_feedback_RouteId_UserId",
                table: "route_feedback",
                columns: new[] { "RouteId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_route_feedback_UserId",
                table: "route_feedback",
                column: "UserId");
        }
