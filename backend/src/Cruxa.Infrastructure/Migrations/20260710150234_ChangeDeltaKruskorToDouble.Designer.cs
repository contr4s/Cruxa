...
namespace Cruxa.Infrastructure.Migrations
{
    ...
    [Migration("20260710150234_ChangeDeltaKruskorToDouble")]
    partial class ChangeDeltaKruskorToDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cruxa.Domain.Entities.GymAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GymId", "UserId", "RoleInGym")
                        .IsUnique();

                    b.ToTable("gym_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Cruxa.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<double?>("DeltaKruskor")
                        .HasColumnType("double precision");
