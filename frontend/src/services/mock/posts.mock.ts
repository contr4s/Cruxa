import type { PostDto, CommentDto, PostDetailDto, RecommendedUserDto, RecommendedRouteDto, RecommendedGymDto, FeedSuggestionsDto } from '../../types/post';
...
export const MOCK_MY_POSTS: PostDto[] = [
  {
    ...
    ascents: [
      ...
      { id: 'a11', routeId: 'r11', routeName: 'Коричневый сахар', grade: '6A', holdColor: 'Brown', style: 'Redpoint', tags: [{ name: 'endurance' , category: 'style' }, { name: 'vert' , category: 'relief' }] },
      { id: 'a12', routeId: 'r12', routeName: 'Крокодил', grade: '5B+', holdColor: 'Green', style: 'Flash', isFlash: true, tags: [{ name: 'slab' , category: 'style' }, { name: 'roof' , category: 'relief' }] },
  ...
  },
  {
    ...
    ascents: [
      ...
      { id: 'a16', routeId: 'r16', routeName: 'Пурпурный туман', grade: '6A', holdColor: 'Purple', style: 'Flash', isFlash: true, tags: [{ name: 'technical' , category: 'style' }, { name: 'sloper' , category: 'hold' }, { name: 'dihedral' , category: 'relief' }] },
      { id: 'a17', routeId: 'r17', routeName: 'Алый парус', grade: '5C', holdColor: 'Red', style: 'Onsight', tags: [{ name: 'endurance' , category: 'style' }, { name: 'steep' , category: 'relief' }, { name: 'toprope' , category: 'type' }] },
  ...
  },
  {
    ...
    ascents: [
      { id: 'a23', routeId: 'r23', routeName: 'Апельсин', grade: '5B', holdColor: 'Orange', style: 'Onsight', tags: [{ name: 'warmup' , category: 'style' }, { name: 'lead' , category: 'type' }] },
      { id: 'a24', routeId: 'r24', routeName: 'Чёрная молния', grade: '7A', holdColor: 'Black', style: 'Attempt', tags: [{ name: 'overhang' , category: 'style' }, { name: 'power' , category: 'style' }] },
      { id: 'a25', routeId: 'r25', routeName: 'Белый рывок', grade: '6A', holdColor: 'White', style: 'Flash', isFlash: true, tags: [{ name: 'technical' , category: 'style' }, { name: 'dynamic' , category: 'style' }, { name: 'pinch' , category: 'hold' }] },
      { id: 'a26', routeId: 'r26', routeName: 'Сирень', grade: '5C', holdColor: 'Purple', style: 'Redpoint', tags: [{ name: 'slab' , category: 'style' }, { name: 'arete' , category: 'relief' }] },
      { id: 'a27', routeId: 'r27', routeName: 'Изумруд', grade: '6B', holdColor: 'Green', style: 'Flash', isFlash: true, tags: [{ name: 'endurance' , category: 'style' }] },
    ],
    likesCount: 8,
    commentsCount: 2,
    isLiked: true,
...
export async function mockGetWorkoutFeed(): Promise<PostDto[]> {
  await mockDelay(400);
  return MOCK_MY_POSTS;
}

export async function mockGetFeedPosts(filter?: 'subs' | 'recommended'): Promise<PostDto[]> {
  await mockDelay(400);
  if (filter === 'recommended') {
    return MOCK_FEED_POSTS.filter((_, i) => i === 2); // рекомендованные
  }
  return MOCK_FEED_POSTS; // подписки — все
}
...
export async function mockGetFeedSuggestions(): Promise<FeedSuggestionsDto> {
  ...
  return {
    ...
    routes: [
      ...
      { id: 'r24', name: 'Чёрная молния', grade: '7A', holdColor: 'Black', rating: 4.6, gymName: 'Лимейт', gymId: 'g3' },
    ...
    gyms: [
      { id: 'g1', name: 'RockZone', rating: 4.5, distance: '1.2 км', area: 1200, maxHeight: 14 },
      { id: 'g2', name: 'BigWall', rating: 4.7, distance: '2.8 км', area: 2500, maxHeight: 18 },
      { id: 'g3', name: 'Лимейт', rating: 4.2, distance: '3.5 км', area: 800, maxHeight: 10 },
    ],
  };
}
