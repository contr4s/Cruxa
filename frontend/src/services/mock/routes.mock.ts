...
export const MOCK_ROUTES: RouteDto[] = [
  // RockZone g1
  {
    ...
    setterId: 's1', setterUsername: 'ivan-rutov', setterName: 'Иван Рутов', setterAvatarUrl: undefined, setterGender: 'male', tags: ['overhang', 'crimp'], description: 'Техничная трасса с перехватами через нависание.', photoUrls: ['/mock/route1-1.jpg'],
  ...
  },
  {
    ...
    setterId: 's2', setterUsername: 'anna-trassova', setterName: 'Анна Трассова', setterAvatarUrl: undefined, setterGender: 'female', tags: ['technical', 'sloper'], description: 'Динамичный мув через большой слоупер.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's1', setterUsername: 'ivan-rutov', setterName: 'Иван Рутов', setterAvatarUrl: undefined, tags: ['endurance', 'arete'], description: 'Классическая трассетка для работы на выносливость.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's3', setterUsername: 'dmitry-zatsep', setterName: 'Дмитрий Зацеп', setterAvatarUrl: undefined, setterGender: 'male', tags: ['power', 'pinch'], description: 'Сложная силовая трасса с пинчами.', photoUrls: ['/mock/route4-1.jpg'],
  ...
  },
  {
    ...
    setterId: 's2', setterUsername: 'anna-trassova', setterName: 'Анна Трассова', setterAvatarUrl: undefined, tags: ['slab', 'pocket'], description: 'Простой боулдер с карманами.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's1', setterUsername: 'ivan-rutov', setterName: 'Иван Рутов', setterAvatarUrl: undefined, tags: ['warmup'], description: 'Разминочная трассетка.', photoUrls: [],
    rating: 4.0, ascentsCount: 340, status: 'Active', createdAt: '2026-03-01T00:00:00Z', isFavorite: false,
  },
  {
    id: 'r7', name: 'Ночной дозор', grade: '6A+', gradeIndex: 11, type: 'Lead', holdColor: 'Black', sector: 'Экстрим', gymId: 'g1', gymName: 'RockZone',
    setterId: 's3', setterUsername: 'dmitry-zatsep', setterName: 'Дмитрий Зацеп', setterAvatarUrl: undefined, setterGender: 'male', tags: ['technical', 'crimp'], description: 'Тёмная трасса с мелкими зацепками.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's2', setterUsername: 'anna-trassova', setterName: 'Анна Трассова', setterAvatarUrl: undefined, tags: ['slab'], description: 'Белый боулдер для начинающих.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's1', setterUsername: 'ivan-rutov', setterName: 'Иван Рутов', setterAvatarUrl: undefined, tags: ['campus'], description: 'Кампус-трасса для тренировки силы рук.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's2', setterUsername: 'anna-trassova', setterName: 'Анна Трассова', setterAvatarUrl: undefined, tags: ['dynamic'], description: 'Розовая динамичная трассетка.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's1', setterUsername: 'ivan-rutov', setterName: 'Иван Рутов', setterAvatarUrl: undefined, tags: ['technical'], description: 'Техничная синяя трасса.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's2', setterUsername: 'anna-trassova', setterName: 'Анна Трассова', setterAvatarUrl: undefined, tags: ['warmup'], description: 'Серая разминка.', photoUrls: [],
  ...
  // BigWall g2
  {
    ...
    setterId: 's4', setterUsername: 'maria-speed', setterName: 'Мария Скорость', setterAvatarUrl: undefined, setterGender: 'female', tags: ['speed', 'dynamic'], description: 'Скоростная трасса по стандарту IFSC.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's5', setterUsername: 'alexey-strong', setterName: 'Алексей Сильный', setterAvatarUrl: undefined, setterGender: 'male', tags: ['overhang', 'power', 'crimp'], description: 'Флагманская трасса зала — длинный нависающий маршрут.', photoUrls: ['/mock/route12-1.jpg'],
  ...
  },
  {
    ...
    setterId: 's4', setterUsername: 'maria-speed', setterName: 'Мария Скорость', setterAvatarUrl: undefined, setterGender: 'female', tags: ['endurance', 'arete'], description: 'Зелёный маршрут по диэдру.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's5', setterUsername: 'alexey-strong', setterName: 'Алексей Сильный', setterAvatarUrl: undefined, tags: ['slab'], description: 'Фиолетовый боулдер на технику.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's4', setterUsername: 'maria-speed', setterName: 'Мария Скорость', setterAvatarUrl: undefined, setterGender: 'female', tags: ['endurance'], description: 'Выносливый зелёный маршрут.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's5', setterUsername: 'alexey-strong', setterName: 'Алексей Сильный', setterAvatarUrl: undefined, tags: ['warmup'], description: 'Разминка на коричневых зацепках.', photoUrls: [],
  ...
  // Лимейт g3
  {
    ...
    setterId: 's6', setterUsername: 'olga-boulder', setterName: 'Ольга Боулдер', setterAvatarUrl: undefined, setterGender: 'female', tags: ['technical', 'sloper'], description: 'Фиолетовый боулдер со слоуперами.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's6', setterUsername: 'olga-boulder', setterName: 'Ольга Боулдер', setterAvatarUrl: undefined, tags: ['endurance', 'slab'], description: 'Красный боулдер на выносливость.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's7', setterUsername: 'pavel-laza', setterName: 'Павел Лаза', setterAvatarUrl: undefined, setterGender: 'male', tags: ['slab', 'dynamic'], description: 'Синий динамичный боулдер.', photoUrls: ['/mock/route19-1.jpg'],
  ...
  },
  {
    ...
    setterId: 's7', setterUsername: 'pavel-laza', setterName: 'Павел Лаза', setterAvatarUrl: undefined, tags: ['warmup'], description: 'Оранжевая разминка.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's6', setterUsername: 'olga-boulder', setterName: 'Ольга Боулдер', setterAvatarUrl: undefined, tags: ['overhang', 'power'], description: 'Тёмный боулдер через крышу.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's7', setterUsername: 'pavel-laza', setterName: 'Павел Лаза', setterAvatarUrl: undefined, tags: ['slab', 'pocket'], description: 'Белый лёгкий боулдер.', photoUrls: [],
  ...
  // НоваЦентр g4
  {
    ...
    setterId: 's8', setterUsername: 'sergey-novy', setterName: 'Сергей Новый', setterAvatarUrl: undefined, setterGender: 'male', tags: ['overhang'], description: 'Красная новинка.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's9', setterUsername: 'natalya-tsentr', setterName: 'Наталья Центр', setterAvatarUrl: undefined, setterGender: 'female', tags: ['technical'], description: 'Синий техничный боулдер.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's8', setterUsername: 'sergey-novy', setterName: 'Сергей Новый', setterAvatarUrl: undefined, tags: ['warmup'], description: 'Жёлтая разминка.', photoUrls: [],
  ...
  // Лодж g5
  {
    ...
    setterId: 's10', setterUsername: 'kirill-lodge', setterName: 'Кирилл Лодж', setterAvatarUrl: undefined, setterGender: 'male', tags: ['power', 'crimp'], description: 'Серый силовой боулдер.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's10', setterUsername: 'kirill-lodge', setterName: 'Кирилл Лодж', setterAvatarUrl: undefined, tags: ['speed'], description: 'Белая скоростная линия.', photoUrls: [],
  ...
  },
  {
    ...
    setterId: 's11', setterUsername: 'evgeny-les', setterName: 'Евгений Лес', setterAvatarUrl: undefined, setterGender: 'male', tags: ['slab', 'endurance'], description: 'Зелёный боулдер на выносливость.', photoUrls: ['/mock/route28-1.jpg'],
...
const MOCK_REVIEWS: Record<string, RouteReviewDto[]> = {
  r1: [
    { id: 'rev1', routeId: 'r1', userId: 'u1', username: 'alexey-k', displayName: 'Алексей К.', rating: 5, comment: 'Отличная трасса, очень техничная. Нависание заставило поработать над перехватами. Рекомендую всем, кто хочет прокачать динамику.', createdAt: '2026-06-10T12:00:00Z' },
    { id: 'rev2', routeId: 'r1', userId: 'u2', username: 'maria-s', displayName: 'Мария С.', rating: 4, comment: 'Красная стрела — классика RockZone. Сложнее, чем кажется на первый взгляд.', createdAt: '2026-06-08T10:30:00Z' },
    { id: 'rev3', routeId: 'r1', userId: 'u3', username: 'dmitry-z', displayName: 'Дмитрий З.', rating: 5, comment: 'Пролез за 3 попытки. Мелкие зацепки — это то, что я люблю.', createdAt: '2026-06-05T18:20:00Z' },
    { id: 'rev4', routeId: 'r1', userId: 'u4', username: 'natalya-ts', displayName: 'Наталья Ц.', rating: 4, comment: 'Хорошая трасса, но грейд чуть занижен.', createdAt: '2026-06-01T09:00:00Z' },
    { id: 'rev5', routeId: 'r1', userId: 'u5', username: 'sergey-n', displayName: 'Сергей Н.', rating: 5, comment: 'Потрясающая линия! Сеттеру респект.', createdAt: '2026-05-28T14:45:00Z' },
    { id: 'rev6', routeId: 'r1', userId: 'u6', username: 'olga-b', displayName: 'Ольга Б.', rating: 3, comment: 'Мне показалось слишком жёстким для 6А.', createdAt: '2026-05-25T11:10:00Z' },
    { id: 'rev7', routeId: 'r1', userId: 'u7', username: 'pavel-l', displayName: 'Павел Л.', rating: 4, comment: 'Динамика в середине — огонь.', createdAt: '2026-05-20T16:00:00Z' },
    { id: 'rev8', routeId: 'r1', userId: 'u8', username: 'kirill-l', displayName: 'Кирилл Л.', rating: 5, comment: 'Одна из лучших трасс зала.', createdAt: '2026-05-18T08:30:00Z' },
  ],
  r2: [
    { id: 'rev9', routeId: 'r2', userId: 'u1', username: 'alexey-k', displayName: 'Алексей К.', rating: 4, comment: 'Боулдер с крутым слоупером. Нужна сила хвата.', createdAt: '2026-06-12T13:00:00Z' },
    { id: 'rev10', routeId: 'r2', userId: 'u2', username: 'maria-s', displayName: 'Мария С.', rating: 5, comment: 'Мой любимый синий мув!', createdAt: '2026-06-09T11:00:00Z' },
    { id: 'rev11', routeId: 'r2', userId: 'u3', username: 'dmitry-z', displayName: 'Дмитрий З.', rating: 4, comment: 'Технично и силово одновременно.', createdAt: '2026-06-04T17:00:00Z' },
  ],
  r3: [
    { id: 'rev12', routeId: 'r3', userId: 'u4', username: 'natalya-ts', displayName: 'Наталья Ц.', rating: 4, comment: 'Идеальная для работы на выносливость.', createdAt: '2026-05-15T10:00:00Z' },
  ],
  r4: [
    { id: 'rev13', routeId: 'r4', userId: 'u5', username: 'sergey-n', displayName: 'Сергей Н.', rating: 5, comment: 'Силовая бомба! Пинчи жгут.', createdAt: '2026-06-14T19:00:00Z' },
    { id: 'rev14', routeId: 'r4', userId: 'u6', username: 'olga-b', displayName: 'Ольга Б.', rating: 4, comment: 'Крутая трасса, но грейд точно не 6С.', createdAt: '2026-06-11T15:00:00Z' },
  ],
  r5: [
    { id: 'rev15', routeId: 'r5', userId: 'u7', username: 'pavel-l', displayName: 'Павел Л.', rating: 4, comment: 'Лёгкий боулдер для разминки. Карманы удобные.', createdAt: '2026-05-10T09:00:00Z' },
    { id: 'rev16', routeId: 'r5', userId: 'u8', username: 'kirill-l', displayName: 'Кирилл Л.', rating: 5, comment: 'Отличный для начинающих.', createdAt: '2026-05-08T12:00:00Z' },
    { id: 'rev17', routeId: 'r5', userId: 'u1', username: 'alexey-k', displayName: 'Алексей К.', rating: 3, comment: 'Слишком просто для разминки.', createdAt: '2026-05-05T11:00:00Z' },
  ],
};
