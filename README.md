...
| 📊 **Крускор (Kruskor)** | Elo-подобный алгоритм, который считает интегральную силу скалолаза. Учитывает грейд трасс, стиль прохождения, давность тренировок, радар из навыков. |
