...
Всего **46 эндпоинтов**. Полная спецификация — [`docs/api-endpoints.md`](docs/api-endpoints.md).

| Категория | Кол-во | Примеры |
|-----------|--------|---------|
| Auth | 2 | регистрация, логин |
| Users | 5 | CRUD пользователей |
| Gyms | 6 | CRUD скалодромов |
| GradingSystems | 3 | справочник систем грейдов |
